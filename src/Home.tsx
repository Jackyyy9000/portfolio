...
export const Home: React.FC = () => {
    return (
        <>
            <div id="home" className='flex flex-col md:flex-row pt-12 md:pt-24 px-6 z-1'>      
                ...
                <div className='flex pb-12 md:pb-0 md:px-4 self-center order-first md:order-2 z-[1]'>
